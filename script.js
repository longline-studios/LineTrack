...
let facts = [
    ...
    "The longest train route in the world is the Trans-Siberian Railway."
];
...
const quizQuestions = [
    ...
    { q: "What is the name of the famous train that connects Paris and Venice?", a: "the orient express" }
];
